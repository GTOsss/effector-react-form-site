...
import { onChangeExampleJs, onChangeExampleTs } from './on-change';
import { onChangeGuardExampleJs, onChangeGuardExampleTs } from './on-change-guard';
...
export const onChangeTypes = `type SubmitParams<Values = any, Meta = any> = {
  values: Values;
  errorsInline: ErrorsInline;
  fieldsInline: FieldsInline;
  form: FormState;
...
export const onChangeExample = {
  jsx: onChangeExampleJs,
  tsx: onChangeExampleTs,
};

export const onChangeGuardsTypes = `type SubmitParams<Values = any, Meta = any> = {
  values: Values;
  errorsInline: ErrorsInline;
  fieldsInline: FieldsInline;
  form: FormState;
...
export const onChangeGuardExample = {
  jsx: onChangeGuardExampleJs,
  tsx: onChangeGuardExampleTs,
};
