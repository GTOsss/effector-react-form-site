  ...
  return (
    <div className="componentRoot">
      ...
      <div>
        ...
        , внешние ошибки не блокируют отправку формы. После изменения значений полей, внешние ошибки скрываются, но остаются в состоянии
        формы. После отправки ошибки будут отображаться снова, пока поля не изменятся.
      </div>
    </div>
  );
};
