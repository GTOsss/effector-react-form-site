const onFocusFieldBrowserExampleTs = `
...
form.onFocusFieldBrowser.watch(({ name }) => console.log(name));
...
const onFocusFieldBrowserExampleJs = `
import React from 'react';
import { createForm, useForm } from 'effector-react-form';
import cn from 'classnames';
...
export const onFocusFieldBrowserExample = {
  jsx: onFocusFieldBrowserExampleJs,
  tsx: onFocusFieldBrowserExampleTs,
};
