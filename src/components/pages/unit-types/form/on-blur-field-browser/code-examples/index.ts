const onBlurFieldBrowserExampleTs = `
...
form.onBlurFieldBrowser.watch(({ name }) => console.log(name));
...
const onBlurFieldBrowserExampleJs = `
import React from 'react';
import { createForm, useForm } from 'effector-react-form';
import cn from 'classnames';
...
export const onBlurFieldBrowserExample = {
  jsx: onBlurFieldBrowserExampleJs,
  tsx: onBlurFieldBrowserExampleTs,
};
